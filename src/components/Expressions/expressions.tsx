          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
            ...
            <div className="flex flex-col gap-8">
              ...
              <div className="bg-[#FFF8EE]/90 backdrop-blur-sm rounded-[32px] p-8 md:p-10 flex flex-col justify-between hover:shadow-2xl hover:shadow-orange-500/10 hover:-translate-y-1 transition-all duration-300 border border-orange-100/50">
                ...
                <div>
                  <button className="group border border-orange-200 text-orange-600 px-6 py-2 rounded-full font-medium hover:bg-orange-50 transition flex items-center gap-2 text-sm bg-transparent w-fit">
                    Explore Verbs <ArrowRight className="w-4 h-4 group-hover:translate-x-1 transition-transform" />
                  </button>
                </div>
              </div>
